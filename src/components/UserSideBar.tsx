...
export const UserSidebar: React.FC = () => {
  ...
  // Filter items:
  // 1. Hide items with `hideForAdmin` if user is ADMIN
  // 2. Hide items with `adminOnly` if user is NOT ADMIN
...
//   // Filter out items that should be hidden for ADMIN
//   const menuItems = baseMenuItems.filter(
//     (item) => !(isAdmin && item.hideForAdmin),
//   );
