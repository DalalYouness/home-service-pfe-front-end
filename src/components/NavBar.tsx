    ...
    <>
      ...
      <nav className="fixed top-0 right-0 left-0 z-50 bg-forest-950/90 backdrop-blur-md border-b border-white/10 shadow-lg transition-all duration-300">
        <div className="max-w-7xl mx-auto px-6 flex items-center justify-between h-20">
          ...
          <button
            className="md:hidden p-2.5 rounded-xl bg-white/10 border border-white/10 text-white hover:bg-white/20 transition-colors cursor-pointer"
        ...
        {menuOpen && (
          <div className="md:hidden bg-forest-950/98 backdrop-blur-xl border-b border-white/10 px-6 py-6 flex flex-col gap-5 shadow-2xl">
            ...
            <button
              ...
              className="flex items-center justify-center gap-2 text-sm font-bold text-forest-950 bg-gradient-to-r from-cream-100 to-amber-100 px-5 py-3 rounded-full w-full mt-2 shadow-lg active:scale-95 transition-all cursor-pointer"
            >
              <User size={18} />
              <span>Connexion</span>
            </button>
